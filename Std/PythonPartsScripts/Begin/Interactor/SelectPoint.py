...
def create_interactor(coord_input, pyp_path, str_table_service):
    ...
    """
    return SelectPoint(coord_input, pyp_path, str_table_service)
...
class SelectPoint():
    ...
    def __init__(self, coord_input, pyp_path, str_table_service):
        ...
        self.coord_input.InitFirstPointInput(AllplanIFW.InputStringConvert("Select element"))
    ...
    def process_mouse_msg(self, mouse_msg, pnt, msg_info):
        ...
        coorInput_rs = self.coord_input.GetInputPoint(mouse_msg, pnt, msg_info,False )
