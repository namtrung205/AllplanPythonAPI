...
print('Load DrawPipe.py')

# Hàm kiểm tra tương thích script và version Allplan
...
# Hàm tạo preview trong lib(thumbnail)
...
# Hàm chính tương tác với Editor(UIDocument) của Allplan
# Trong ví dụ này chúng ta sẽ phân tích chi tiết hàm này và lớp DrawPipe
def create_interactor(coord_input, pyp_path, str_table_service):
    ...
    """
    return DrawPipe(coord_input, pyp_path, str_table_service)
...
class DrawPipe():
    ...
    def __init__(self, coord_input, pyp_path, str_table_service):
        """
        Initialization of class DrawPipe
        ...
        # Pick point đầu tiên trong Editor
    ...
    # Hàm thực thi khi Pick chuột trái trên màn hình editor
